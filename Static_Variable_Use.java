...
public class Constant_for_every_instance 
{
    public static void main(String [] args)
    {
    	  ...
    	  System.out.println(Aritra.name+" - "+Aritra.age+" - "+ Aritra.salary+" - "+Aritra.married+ " The current number of employee w.r.t Aritra is :"+Aritra.employee_number);
    	  System.out.println(" The current number of employee w.r.t Promi is :"+Promi.employee_number);
    	  System.out.println(" The current number of employee w.r.t Hrishin is :"+Hrishin.employee_number);
